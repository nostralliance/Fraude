...
def base64topdf():
    with open(r"C:\Users\tomlo\Documents\GitHub\Fraude\code_Tom\base64_to_pdf\api\base64.json", 'r') as f:
...
def pdf2img(pdfFile: str ,pages: Tuple = None):
    ...
    for pageId in range(pdf.page_count):
        ...
        pngPath = r'C:\Users\tomlo\Documents\GitHub\Fraude\code_Tom\docker\v2\app2\images'+ '/' + str(paths.rootPath) + paths.tmpDir + os.path.basename(pdfFile) +'/'
